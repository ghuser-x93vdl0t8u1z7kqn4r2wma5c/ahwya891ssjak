        ...
        <div className="mt-16 border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-8">
              <Link href="/mobile-apps" className="text-white/80 hover:text-white transition-colors">
                Mobile Apps
              </Link>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-8 pt-8 border-t border-white/20">
            ...
            <div className="flex items-center space-x-8 mt-4 md:mt-0">
              ...
              <Link href="/cookie-settings" className="text-white/80 hover:text-white transition-colors">
                Cookie Settings
              </Link>
            </div>
          </div>
